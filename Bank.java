	...
	public static void main(String[] args) {
		...
		b.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (new String(value.getPassword()).equals("6767") && text.getText().equals("hasvanth")) {
					...
					j5.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							String data[][] = { { "Yashwanth", "123", "70000", "7075453816" },
									{ "Phani", "456", "10000", "9573607182" },
									{ "Suzan", "789", "1000000", "7416772272" } };
						...
						public void actionPerformed(ActionEvent e) {
							...
							select.addListSelectionListener(new ListSelectionListener() {
								public void valueChanged(ListSelectionEvent e) {
									...
									JLabel atw = new JLabel("Amount to Be Withdrawn");
					...
					j3.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							String[] year = new String[135];
							for (int i = 0; i < 135; i++) {
								year[i] = Integer.toString(1890 + i);
							}
							...
							JComboBox<String> d = new JComboBox<>(date);
							...
							save.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									...
									ta1.setText("The name of the applicany is " + name.getText()
											...
											+ guardian.getText() + "\n Name of the applicanys mother is "
											...
											+ "\n Address of the applicant is " + address.getText() + ","
											+ street.getText() + ","
					...
					JOptionPane.showMessageDialog(f, "userid or password incorrect", "Alert",
